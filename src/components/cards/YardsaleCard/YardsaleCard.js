    ...
    return (
      <Fragment>
        <Card
          ...
          as={Grid}
          fluid
          className={`yardsale-card top aligned left justified ${
        ...
        >
          ...
          {(yardsale.notes.length > 0 || yardsale.address_text.length > 0) && (
            <Divider className="my0 mx0" fitted></Divider>
          )}
          <Grid.Row className="py0">
            <Grid.Column computer={10} mobile={16}>
              <Card.Content>
                {yardsale.address_text && yardsale.address_text.length > 1 && (
                  <Card.Description>
          ...
          {yardsale.yardsale_seller_links &&
            yardsale.yardsale_seller_links.sellers &&
            yardsale.yardsale_seller_links.sellers.length > 1 && (
              <Fragment>
                <Divider horizontal className=""></Divider>
                <Divider horizontal className="">
                  Active Sellers{" "}
                  <Icon
                    name="user"
                    onClick={() => {
                      setExpandSellers(!expandSellers);
                    }}
                  ></Icon>
                </Divider>
                {expandSellers && (
