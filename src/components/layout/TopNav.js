...
const LeftMenu = ({ user, isAuthenticated, activeItem, setActiveItem, userQuery }) => {
...
const RightMenu = ({ user, isAuthenticated, activeItem, setActiveItem, userQuery }) => {
    ...
    return (
        <Fragment>
            ...
            <Responsive as={Fragment} minWidth={768} >
                ...
                {auth.isAuthenticated && (
                    <Menu.Item position="right" as={Link} onClick={() => auth.logout(auth, setAuth)} content="Logout" icon="power off" key="logout" index={101} className="horizontal" >
            ...
            <Responsive as={Fragment} maxWidth={768} >
                <Menu.Item as="a" key="mobile-toggle" index="mobile-toggle" onClick={() => setSidebarVisible(!sidebarVisible)} className="horizontal" position="right"><Icon name="bars"></Icon></Menu.Item>
                <SidebarNav visible={sidebarVisible} setVisible={setSidebarVisible} userQuery={userQuery}></SidebarNav>
            </Responsive>
        </Fragment>
    )
}
