...
const RegisterModal = ({ defaultOpen = false, forcedOpen = false, ...props }) => {
    ...
    return (
        <Fragment>
            ...
            <Menu.Item as="a" index={0} content="Create a New Account" className="horizontal hover-pointer" onClick={openModal} />
            ...
            >
                ...
                <Modal.Content scrolling>
                    <Form as={Grid} className="m0" loading={auth.loading}>
                        ...
                        <Grid.Row className="py0">
                            <Grid.Column>
                                <Item as={Link} to="/login" className="hover-pointer" content="Already have an account? Log in." onClick={closeModal} ></Item>
                            </Grid.Column>
                        </Grid.Row>
                    </Form>
                </Modal.Content>
                        ...
                        <Grid.Row columns={2}>
                            ...
                            <Grid.Column width={8}>
                                <Button
                                    ...
                                    disabled={values.email == '' || values.password == '' || values.password.length < 4 || (values.password !== values.confirmPassword)}
                                />
                            </Grid.Column>
                        </Grid.Row>
                    </Grid>
