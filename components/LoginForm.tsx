...
export const LoginForm: React.FC = (props) => {
  ...
  return (
    <Segment raised padded size="huge" style={{marginTop: "25%", maxWidth: 500, marginLeft: "auto", marginRight: "auto"}}>
        ...
        <Grid verticalAlign="middle">
          ...
          <Grid.Row className="pb8 pt16" divided centered>
            <Grid.Column width={8} textAlign="left">
              <Link href="/register" as="register">Create a New Account</Link>
            </Grid.Column>

            <Grid.Column width={8} textAlign="right">
              <Link href="/password-reset" as="/password-reset">Forgot your password?</Link>
            </Grid.Column>
          </Grid.Row>
        </Grid>
      </Form>
